 ...
 */
package com.mycompany.bondiemtrenmatphang;
...
public class Point3D 
{
    ...
    public static boolean check(Point3D A, Point3D B, Point3D C, Point3D D)
    {
        ...
        Point3D ABtchAC = new Point3D(AB.y*AC.z - AB.z * AC.y, AB.z*AC.x - AB.x*AC.z, AB.x*AC.y - AB.y*AC.x);
        return ABtchAC.x  * AD.x + ABtchAC.y * AD.y + ABtchAC.z * AD.z == 0;
    }
}
