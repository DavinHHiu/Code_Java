...
public class VDV implements Comparable <VDV>
{
    ...
    private Date ngaySinh, tgXuatPhat, tgVeDich, tgUuTien, thanhTichThuc, thanhTich;
    ...
    public VDV(int i, String ten, String ngaySinh, String tgXuatPhat, String tgVeDich) throws ParseException
    {
        ...
        this.thanhTichThuc = tinhHieuTG(this.tgVeDich, this.tgXuatPhat); 
        this.tuoi = tinhTuoi();
        this.tgUuTien = tinhTgUuTien();
        this.thanhTich = tinhHieuTG(this.thanhTichThuc, this.tgUuTien);
    }
    
    private Date tinhHieuTG(Date x, Date y) throws ParseException
    {
    ...
    private Date tinhTgUuTien() throws ParseException
    {
    ...
    {
        return this.ma + " " + this.ten + " " + new SimpleDateFormat("HH:mm:ss").format(this.thanhTichThuc) + " " + new SimpleDateFormat("HH:mm:ss").format(this.tgUuTien)
                + " " + new SimpleDateFormat("HH:mm:ss").format(this.thanhTich) + " " + this.xepHang;
    }
